...
const quizQuestions: QuizQuestion[] = [
  {
    ...
    options: [
      ...
      {
        id: "moderate",
        label: "I enjoy some activity but prefer moderation",
        points: 2,
      },
      {
        id: "low_energy",
        label: "I prefer quiet, low-energy activities",
        points: 1,
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        id: "manageable",
        label: "I can deal with regular grooming and cleaning",
        points: 2,
      },
      {
        id: "prefer_minimal",
        label: "I prefer minimal shedding pets",
        points: 0,
      },
    ],
  },
  {
    ...
    options: [
      {
        id: "experienced",
        label: "I'm experienced with smart, stubborn dogs",
        points: 3,
      },
      {
        id: "beginner_willing",
        label: "I'm new but willing to learn!",
        points: 2,
      },
      {
        id: "want_easy",
        label: "I want a dog that's naturally obedient",
        points: 1,
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        id: "photography",
        label: "Taking adorable photos for social media",
        points: 1,
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        id: "apartment_active",
        label: "Apartment but I'm very active",
        points: 2,
      },
      {
        id: "apartment_quiet",
        label: "Apartment with a quieter lifestyle",
        points: 1,
      },
    ],
  },
...
const getQuizResult = (score: number): QuizResult => {
  if (score >= 12) {
    return {
      ...
      description:
        "You're absolutely ready for corgi ownership! Your lifestyle, energy, and expectations align perfectly with what these amazing dogs need. A corgi would thrive in your care!",
      emoji: "🏆",
    };
  } else if (score >= 8) {
    return {
      ...
      description:
        "You'd make a great corgi parent! You understand the commitment and have the right mindset. With a little preparation, you and a corgi would be perfect together!",
      emoji: "🎉",
    };
  } else if (score >= 5) {
    return {
      ...
      title: "Corgi Curious! 🤔",
      description:
        "You're interested in corgis but might want to research more. Consider meeting some corgis, talking to owners, and making sure you're ready for their energy and needs.",
      emoji: "🤔",
    };
  } else {
    return {
      ...
      description:
        "While corgis are amazing, they might not be the perfect fit for your current lifestyle. Consider lower-energy or less demanding breeds that might suit you better!",
      emoji: "🐕",
    };
  }
};
...
export function CorgiQuiz() {
  ...
  const handleAnswer = (
    ...
    if (currentQuestion < quizQuestions.length - 1) {
      ...
      const totalScore = Object.values(newAnswers).reduce((total, answer) => {
        return (
          total +
          (Array.isArray(answer.points)
            ? answer.points.reduce((a: number, b: number) => a + b, 0)
            : answer.points)
        );
      }, 0);
                  ...
                  <div className="space-y-3">
                        ...
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => {
                            const currentAnswers =
                              answers[currentQ.id]?.answerId || [];
                            const currentPoints =
                              answers[currentQ.id]?.points || [];
                            ...
                            if (checked) {
                              ...
                              newPoints = currentPoints.filter(
                                (_: number, index: number) =>
                                  currentAnswers[index] !== option.id,
                              );
                            }
                    ...
                    <Button
                      onClick={() => {
                        ...
                        if (
                          currentAnswers &&
                          currentAnswers.answerId.length > 0
                        ) {
                          handleAnswer(
                            currentQ.id,
                            currentAnswers.answerId,
                            currentAnswers.points,
                          );
                        }
                      }}
                      disabled={
                        !answers[currentQ.id] ||
                        answers[currentQ.id].answerId.length === 0
                      }
            ...
            <Card className="shadow-corgi animate-fade-in-up text-center">
              <CardContent className="p-12">
                ...
                <p className="text-muted-foreground mb-6 leading-relaxed">
                  Answer 5 quick questions to discover if you're ready for corgi
                  ownership!
                </p>
                <Button
                  onClick={handleStart}
                  size="lg"
                  className="shadow-corgi hover-bounce"
                >
                  Start Quiz
                </Button>
              </CardContent>
