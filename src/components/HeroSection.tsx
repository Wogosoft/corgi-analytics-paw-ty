      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center space-y-8 animate-fade-in-up">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Discover why these adorable, low-riding companions are stealing hearts 
            worldwide with their wiggling butts and endless charm.
          </p>
          ...
          <div className="pt-12 animate-pulse">
            ...
            <p className="text-sm text-muted-foreground mt-2">Scroll for more cuteness</p>
          </div>
        </div>
      </div>
    </section>
