...
const corgiPros: CorgiPro[] = [
  {
    ...
    description:
      "Corgis form incredibly strong bonds with their families and will follow you everywhere.",
  ...
  },
  {
    ...
    description:
      "Despite their short legs, they have the energy of a dog twice their size.",
  ...
  },
  {
    ...
    description:
      'Their natural "smile" and expressive face will brighten your worst days.',
